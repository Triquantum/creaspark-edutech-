    ...
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-gradient-to-br from-[#0F172A] via-[#12263F] to-[#255C99] px-4">
      ...
      <div className="glass relative w-full max-w-md rounded-3xl p-8 shadow-lift">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input id="email" type="email" required value={email}
              ...
              className="h-11 w-full rounded-xl border border-slate-200 bg-white/80 px-4 text-sm outline-none focus:border-accent focus:ring-2 focus:ring-accent/25" />
          </div>
          <div>
        ...
        <p className="mt-8 text-center text-xs text-slate-400">
          Demo login: admin@demo.educore.in / Educore@123
        </p>
      </div>
    </main>
  );
