...
import {
  ...
  IdCard, Settings2, Globe, Settings, GraduationCap, CheckSquare, Award, TrendingUp, Cpu,
} from "lucide-react";
import { NAV, NavGroup, Role, visibleTo } from "@/lib/nav-config";
...
const ICONS: Record<string, LucideIcon> = {
  ...
  "graduation-cap": GraduationCap, "check-square": CheckSquare, award: Award,
  "trending-up": TrendingUp, cpu: Cpu,
};
